      ...
      <div className="relative w-full max-w-4xl h-full max-h-[80vh] flex flex-col">
        ...
        <div className="bg-white bg-opacity-90 p-4 rounded-b-lg">
          ...
          <p className="text-xs text-black mt-1">
            Magasin:{" "}
            {currentAd.magazine === "both"
              ? "Begge magasiner"
              : currentAd.magazine === "udogse"
              ? "Ud & Se"
              : "Samvirke"}
          </p>
        </div>
...
export default function AdInspirationGrid() {
  ...
  const filteredAds = inspirationAds.filter(
    (ad) => ad.magazine === "both" || ad.magazine === selectedMagazine
  );
    ...
    <div className="max-w-6xl mx-auto px-4 py-8 text-black" id="inspiration">
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-sm font-medium">
            Udforsk kreativ annonceinspiration til dit næste opslag i{" "}
            <strong>Ud & Se</strong> eller <strong>Samvirke</strong>.
          </p>
        </div>
      </div>
            ...
            style={{
              ...
              color:
                selectedMagazine === "samvirke"
                  ...
                  : "#FF0000",
              border:
                selectedMagazine === "samvirke" ? "none" : "2px solid #FF0000",
            }}
          ...
          >
            <div className="relative w-full h-full">
              ...
              >
                ...
                <p className="text-sm text-white">{ad.description}</p>
              </div>
            </div>
      ...
      <div className="text-center mt-8">
        <p className="text-md mb-4">
          Bliv inspireret og skab din egen kreative annonce i dag.
        </p>
        <Link
          href="#home"
